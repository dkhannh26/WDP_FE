...
import Account from "../pages/admin-management/Account";
import { default as Discount, default as Voucher } from "../pages/admin-management/Discount";
import Import from "../pages/admin-management/Import";
...
import Size from "../pages/admin-management/Size";
