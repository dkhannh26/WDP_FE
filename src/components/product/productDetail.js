import { Button, Col, Image, InputNumber, Row, Space, Typography } from 'antd';
...
const ProductDetail = () => {
    ...
    useEffect(() => {
        getProductDetail(id, setProduct, setImages, setCanvas, selectSize)
    }, [id])
                    ...
                    >
                        <Col span={24}>
                            {product?.size.map((item, index) => {
                                console.log('item', item.size_name)
                                return (
