...
import DetailInventoryModalAdd from "./DetailInventoryModalAdd";
  ...
  const handleSearch = (values) => {
    ...
    if (status) {
      filtered = filtered.filter((item) => {
        ...
        if (status === "lowStock" && totalQuantity <= 5 && totalQuantity > 0)
          return true;
    ...
    <>
      ...
      <Row>
        <Col span={10}>
          ...
          <AddImport data={data} setData={setData} />
        </Col>
        <Col span={14}>
          <Flex
            gap="middle"
      ...
      <DetailInventoryModal
        inventoryDetail={inventoryDetail}
        isModalOpen={isModalOpen}
        handleCancel={handleCancel}
      ></DetailInventoryModal>

      <DetailInventoryModalAdd
        inventoryDetail={inventoryDetail}
